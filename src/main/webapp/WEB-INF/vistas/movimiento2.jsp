    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="container-fluid" >
		 ...
		 <div>
          <form action="transferencia" id="idForm_tra" method="post"> 
		 	<div class="col-md-4">
    ...
    fields: {
    	...
    	cuentaDestino:{
			...
			validators : {
				...
				regexp :{
					regexp: /^[0-9]{15}$/ ,
                    message: 'La cuenta destino tiene 15 dígitos'
				},
				remote :{
            	    delay: 1000,
            	 	url: 'buscaCuenta',
